...
class StudentService:
    ...
    def get_all_students(self):
        ...
        cursor.execute("""
            SELECT id, name, math_marks, science_marks, english_marks, average, result
            FROM students
            ORDER BY id DESC
        """)
    ...
    def create_student(self, name, math_marks, science_marks, english_marks):
        ...
        cursor.execute("""
            INSERT INTO students (
                name, math_marks, science_marks, english_marks, average, result
            )
            VALUES (?, ?, ?, ?, ?, ?)
        """, (name, math_marks, science_marks, english_marks, average, result))
    ...
    def update_student(self, student_id, name, math_marks, science_marks, english_marks):
        ...
        cursor.execute("""
            UPDATE students
            SET name = ?, math_marks = ?, science_marks = ?, english_marks = ?, average = ?, result = ?
            WHERE id = ?
        """, (name, math_marks, science_marks, english_marks, average, result, student_id))
